...
//	Attribute devenum_spectrum_rw class definition
class devenum_spectrum_rwAttrib: public Tango::SpectrumAttr
{
public:
	devenum_spectrum_rwAttrib():SpectrumAttr("devenum_spectrum_rw",
			Tango::DEV_ENUM, Tango::READ_WRITE, 4096) {};
	~devenum_spectrum_rwAttrib() {};
	virtual void read(Tango::DeviceImpl *dev,Tango::Attribute &att)
		{(static_cast<TangoTest *>(dev))->read_devenum_spectrum_rw(att);}
	virtual void write(Tango::DeviceImpl *dev,Tango::WAttribute &att)
		{(static_cast<TangoTest *>(dev))->write_devenum_spectrum_rw(att);}
	virtual bool is_allowed(Tango::DeviceImpl *dev,Tango::AttReqType ty)
		{return (static_cast<TangoTest *>(dev))->is_devenum_spectrum_rw_allowed(ty);}
	virtual bool same_type(const type_info &in_type) {return typeid(devenum_spectrum_rwEnum) == in_type;}
	virtual string get_enum_type() {return string("devenum_spectrum_rwEnum");}
};
