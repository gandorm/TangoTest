...
void TangoTestClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	//	Attribute : devenum_spectrum_rw
	devenum_spectrum_rwAttrib	*devenum_spectrum_rw = new devenum_spectrum_rwAttrib();
	Tango::UserDefaultAttrProp	devenum_spectrum_rw_prop;
	//	description	not set for devenum_spectrum_rw
	//	label	not set for devenum_spectrum_rw
	//	unit	not set for devenum_spectrum_rw
	//	standard_unit	not set for devenum_spectrum_rw
	//	display_unit	not set for devenum_spectrum_rw
	//	format	not set for devenum_spectrum_rw
	//	max_value	not set for devenum_spectrum_rw
	//	min_value	not set for devenum_spectrum_rw
	//	max_alarm	not set for devenum_spectrum_rw
	//	min_alarm	not set for devenum_spectrum_rw
	//	max_warning	not set for devenum_spectrum_rw
	//	min_warning	not set for devenum_spectrum_rw
	//	delta_t	not set for devenum_spectrum_rw
	//	delta_val	not set for devenum_spectrum_rw

	{
		...
		labels.push_back("C");
		labels.push_back("D");
		devenum_spectrum_rw_prop.set_enum_labels(labels);
	}
	devenum_spectrum_rw->set_default_properties(devenum_spectrum_rw_prop);
	//	Not Polled
	devenum_spectrum_rw->set_disp_level(Tango::OPERATOR);
	//	Not Memorized
	att_list.push_back(devenum_spectrum_rw);
