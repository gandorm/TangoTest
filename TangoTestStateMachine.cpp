...
//--------------------------------------------------------
/**
 *	Method      : TangoTest::is_devenum_spectrum_rw_allowed()
 *	Description : Execution allowed for devenum_spectrum_rw attribute
 */
//--------------------------------------------------------
bool TangoTest::is_devenum_spectrum_rw_allowed(TANGO_UNUSED(Tango::AttReqType type))
{
	//	Not any excluded states for devenum_spectrum_rw attribute in Write access.
	/*----- PROTECTED REGION ID(TangoTest::devenum_spectrum_rwStateAllowed_WRITE) ENABLED START -----*/

	/*----- PROTECTED REGION END -----*/	//	TangoTest::devenum_spectrum_rwStateAllowed_WRITE

	//	Not any excluded states for devenum_spectrum_rw attribute in read access.
	/*----- PROTECTED REGION ID(TangoTest::devenum_spectrum_rwStateAllowed_READ) ENABLED START -----*/

	/*----- PROTECTED REGION END -----*/	//	TangoTest::devenum_spectrum_rwStateAllowed_READ
	return true;
}
